        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (variantId is null)
            {
                ...
                await indeterminateMarker.CreateAsync(overwrite: false).ConfigureAwait(false);
            ...
            catch when (variantId is null && indeterminateMarker is not null)
            {
                ...
                if (ex is not null)
                    await LogToMarkerAsync(indeterminateMarker, "CLEANUP AFTER FAILED MOVE ERROR", ex.ToString(), ignoreErrors: true).ConfigureAwait(false);
