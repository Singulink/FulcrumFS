...
public sealed class FileProcessContext : IAsyncDisposable
{
    ...
    internal FileProcessContext(FileId fileId, IAbsoluteDirectoryPath workRootDirectory, IAbsoluteFilePath filePath, CancellationToken cancellationToken)
    {
        _fileId = fileId;
    ...
    internal FileProcessContext(FileId fileId, IAbsoluteDirectoryPath workRootDirectory, Stream stream, string extension, bool leaveOpen, CancellationToken cancellationToken)
    {
        _fileId = fileId;
        _workRootDirectory = workRootDirectory;
