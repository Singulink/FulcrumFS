        ...
        for (int i = 0; i < info.Streams.Length; i++)
        {
            ...
            switch (stream)
            {
                case FFprobeUtils.VideoStreamInfo videoStream:
                    ...
                    tw.WriteLine("Is Still Image: " + videoStream.IsStillImage);
                    tw.WriteLine("Is Default Stream: " + videoStream.IsDefaultStream);
                    tw.WriteLine("Is Bad Candidate For Thumbnail: " + videoStream.IsBadCandidateForThumbnail);
                    ...
                    if (videoStream.HasNonStandardDisplayMatrix) tw.WriteLine("Has Non Standard Display Matrix: " + videoStream.HasNonStandardDisplayMatrix);
                    break;
        ...
        [
            ...
            [
                new FFprobeUtils.VideoStreamInfo(
                    ...
                    AlphaMode: false,
                    Rotation: 0,
                    HasNonStandardDisplayMatrix: true),
                new FFprobeUtils.AudioStreamInfo(
                    CodecName: AudioCodec.AAC.Name,
                    ProfileName: AudioCodec.AAC.Profile,
                    Language: "und",
